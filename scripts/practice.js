...
function animate(elapsed) {
        ...
        if(count1%2==0){ //console.log("circle1"); //console.log(elapsed);
         count1=1;}
        if(count2%2==0){ //console.log("circle2");//console.log(elapsed); 
        count2=1;}
...
function save_json(type,id,value,s1,s2){  
	...
	var date_1= new Date();
      results_json.push({Type: type, ID: id, Value: value, Speed1: s1, Speed2:s2});// contour: i+1, points: highlight_data[i]})
